...
Version  : 0.2.8.3
Release  : 5
URL      : https://cran.r-project.org/src/contrib/spData_0.2.8.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spData_0.2.8.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1522111427
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library spData|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
