...
Version  : 0.2.8.1
Release  : 1
URL      : https://cran.r-project.org/src/contrib/spData_0.2.8.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spData_0.2.8.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521209743
